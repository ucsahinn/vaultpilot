...
| --- | --- | --- | --- |
| ![Windows icon](assets/icons/windows.svg) | [PassMan-1.8.21-x64.msi](https://github.com/ucsahinn/passman/releases/download/v1.8.21/PassMan-1.8.21-x64.msi) | Installs or upgrades PassMan Server on Windows. | GitHub Release |
...
| --- | ---: | --- |
| PassMan Enterprise Vault Console | 1.8.21 | Windows MSI / Update Center |
