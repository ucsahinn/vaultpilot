...
| Bileşen | Sürüm | Asset |
| --- | ---: | --- |
| PassMan Enterprise Vault Console | 1.7.0 | `PassMan-1.7.0-x64.msi` |
...
| Update manifest | 1.7.0 channel metadata | `passman-update.json` |
...
2. Release tag değerinin `v1.7.0` olduğunu doğrula.
3. `passman-update.json` indir.
4. Manifestin server version olarak `1.7.0` gösterdiğini doğrula.
5. MSI filename değerinin `PassMan-1.7.0-x64.msi` olduğunu doğrula.
