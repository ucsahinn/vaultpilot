...
Only the latest public PassMan release is supported for new installations and updates. The current supported public release is **PassMan Enterprise Vault Console 1.7.0**. Older public downloads are retired after their notes are consolidated into `RELEASES.md`.
