...
| VaultPilot Backup Tool | 1.0.2 | Sunucuyla gelen destek bileşeni; ayrı GitHub Release dosyası değildir |
| VaultPilot Log Collector | 1.0.2 | Sunucuyla gelen destek bileşeni; ayrı GitHub Release dosyası değildir |
