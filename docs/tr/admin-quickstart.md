...
| Adım | Aksiyon | Kanıt |
| --- | --- | --- |
| 1 | Son GitHub Release üzerinden `PassMan-1.8.21-x64.msi` dosyasını indir. | Dosya adı, boyut ve release tag [asset doğrulama](release-asset-verification.md) sayfasıyla uyumlu. |
| 2 | Pakete güvenmeden önce imzalı update manifestini doğrula. | `passman-update.json` içinde `1.8.21`, MSI hash, boyut ve signer thumbprint görünür. |
