...
Treat the GitHub Release asset metadata as the public source of truth. Local rebuild artifacts, copied files, support attachments and chat uploads are not release evidence.
...
The public GitHub Release contains these customer-safe delivery assets:
